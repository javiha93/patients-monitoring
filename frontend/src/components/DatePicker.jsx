...
function CalendarDropdown({ anchorRect, viewYear, viewMonth, setViewYear, setViewMonth, yearSelectOpen, setYearSelectOpen, selectedDate, onSelectDay, onPrevMonth, onNextMonth }) {
  ...
  const openAbove = spaceBelow < DROPDOWN_HEIGHT && anchorRect.top > spaceBelow
  const style = {
    position: 'fixed',
  ...
  return createPortal(
    <div style={style} className="bg-white rounded-xl shadow-lg border border-slate-200 p-3" data-datepicker-dropdown>
